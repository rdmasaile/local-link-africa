    ...
    <div className="bg-white text-black min-h-screen">
      ...
      <aside className="bg-gray-900 text-white w-64 p-6 fixed h-full">
        ...
        <nav className="space-y-4">
          <a href="#" className="block text-gray-400">Popular Products</a>
          <a href="#" className="block font-bold">Explore New</a>
          <a href="#" className="block text-gray-400">Clothing and Shoes</a>
          <a href="#" className="block text-gray-400">Gifts and Living</a>
          <a href="#" className="block text-gray-400">Inspiration</a>
        </nav>
        <div className="mt-12">
          <button className="bg-gray-700 text-white px-4 py-2 rounded-md">Log out</button>
        </div>
      </aside>
      ...
      <main className="ml-64 p-8">
        ...
        <header className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center space-x-4">
            <button className="bg-gray-200 text-black px-4 py-2 rounded-full">Filters</button>
            <div className="bg-gray-200 rounded-full p-2">🔔</div>
            <div className="bg-gray-200 rounded-full p-2">👤 Ryana</div>
          </div>
        </header>
        ...
        <section className="mt-8">
          ...
          <div className="bg-gray-200 p-4 rounded-lg flex items-center justify-between">
            ...
            <button className="bg-gray-300 text-black px-4 py-2 rounded-full">See All</button>
          </div>
        </section>
      </main>
    </div>
